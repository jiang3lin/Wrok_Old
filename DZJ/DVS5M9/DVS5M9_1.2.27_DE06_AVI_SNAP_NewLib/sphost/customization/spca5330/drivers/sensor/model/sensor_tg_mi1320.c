...
#define CAPTURE_VSIZE  960/*1024		/* capture vertical size*/


/* Preview default definition here */
/*****TODO***multiple preview mode for VGA*/
#define PREVIEW_VGA_LINETOTAL   1024		/* preview Hd length*/
#define PREVIEW_VGA_LINEBLANK   352		/* preview Hd sync length*/
#define PREVIEW_VGA_FRAMETOTAL  522		/* preview Vd length*/
#define PREVIEW_VGA_FRAMEBLANK  4			/* preview Vd sync length*/
#define PREVIEW_VGA_HOFFSET     334         	/* preview Hd valid pixel data offset position*/
#define PREVIEW_VGA_VOFFSET     10			/* preview Vd valid line data offset position*/
/* Preview resh_VGA_pe sync signal definition here */
#define PREVIEW_VGA_HRESHAPE_FALL         40 		/* preview Hd reshap fall*/
#define PREVIEW_VGA_HRESHAPE_RISE         50		/* preview Hd reshap rise*/
#define PREVIEW_VGA_VRESHAPE_COUNTER_SEL  1	/* preview Vd reshap control*/
#define PREVIEW_VGA_VRESHAPE_FALL         8 	/* preview Vd reshap fall*/
#define PREVIEW_VGA_VRESHAPE_RISE         10 	/* preview Vd reshap rise*/
...
#define CAPTURE_LINETOTAL   1828		/* capture Hd length*/
#define CAPTURE_LINEBLANK   718			/* capture Hd sync length*/
#define CAPTURE_FRAMETOTAL  1042		/* capture Vd length*/
#define CAPTURE_FRAMEBLANK  70			/* capture Vd sync length*/
#define CAPTURE_HOFFSET     484         		/* capture Hd valid pixel data offset position*/
#define CAPTURE_VOFFSET     10   			/* capture Vd valid line data offset position*/
/* Capture reshape sync signal definition here */
#define CAPTURE_HRESHAPE_FALL         80	/* capture Hd reshap fall*/
#define CAPTURE_HRESHAPE_RISE         90	/* capture Hd reshap rise*/
#define CAPTURE_VRESHAPE_COUNTER_SEL  1	/* capture Vd reshap control*/
#define CAPTURE_VRESHAPE_FALL         8	/* capture Vd reshap fall*/
#define CAPTURE_VRESHAPE_RISE         10 	/* capture Vd reshap rise*/
...
#define	CAPTURE_HDNUM_FRAME_END	     1026   	/*the rear interrupt line number of the snap new frame*/
#define	CAPTURE_HDNUM_CMDPORT		100   	/*the command port interrupt line number of the snap new frame*/
...
sensorDoFuncInit()
{
	...
	tmrUsWait(1000);  /* delay 100 ms for reset*/
...
sensorDoFuncSnapReadoutEnd()
{
	...
	/*HLPrintf2("TEST SIZE (%d x %d)",READ16(0xb00090cc),READ16(0xb00090ce));*/
...
)
{
	...
	/*HLPrintf3("EXP[%d] = %d  %d" , pdata[0] ,pdata[1],pdata[2]);*/
