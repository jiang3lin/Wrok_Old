...
#define MODEL_VERSION     "$unp_tg_mt9f002-0.00.20"
...
#if(CPU_CLK==6)                      /*CPU_CLK = 300MHz PCLK 1X = 150MHz*/
    #define MCLK2MCLK(a)     (a)
#elif (CPU_CLK==8)                   /*CPU_CLK = 360MHz                 */
...
{/*HW RESET, OTPM write workaround*/
    {0x3140, 0x2114},  /*as talk on phone, R0x3140=0x2114 from 0x2214 bcs Aptina-Larry type error. */ 	
    {0x304A, 0x0010},    
    {END_CMD,END_CMD}
};
...
{   
    ...
    /*  [Preview-1096x822@60fps]--> drop to 30fps */
    /*  MI_REG(0x301A, 0x0018),*/   
    MI_REG(0x0340, 1802  ),    /* FRAME_LENGTH_LINES:901x2  */                                                                                                  
...
static const sensorSyncSigCfg_t sensorSyncSigPreviewVGA30fpsCfg = {
	...
	.hsize           = PREVIEW_VGA_HSIZE_30FPS,
	.vsize           = PREVIEW_VGA_VSIZE_30FPS,
	.lastlinepix     = PREVIEW_VGA_30FPS_LINETOTAL,
	.hdvdopos        = 0,
	.conf_totalsync  = 0,
	.conf_hdpol      = 0,
	.conf_vdpol      = 0,
...
static const sensorSyncSigCfg_t sensorSyncSigPreviewVGA60fpsCfg = {
	...
	.hsize           = PREVIEW_VGA_HSIZE_60FPS,
	.vsize           = PREVIEW_VGA_VSIZE_60FPS,
	.lastlinepix     = PREVIEW_VGA_60FPS_LINETOTAL,
	.hdvdopos        = 0,
	.conf_totalsync  = 0,
	.conf_hdpol      = 0,
	.conf_vdpol      = 0,
