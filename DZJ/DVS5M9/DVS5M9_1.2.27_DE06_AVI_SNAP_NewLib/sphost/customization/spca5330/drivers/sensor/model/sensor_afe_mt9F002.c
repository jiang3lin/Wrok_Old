...
#define MODEL_VERSION "$unp_afe_mt9F002-0.00.02"
...
void sensorAfe_mt9F002_Install()
{
...
{
#if 1
	/*profLogPrintf(1,"[%x %x %x %x] [%x %x %x %x]",pdata[0],pdata[1],pdata[2],pdata[3],pdata[4],pdata[5],pdata[6],pdata[7]);*/
#if AFE_PRE_GAIN_EN
