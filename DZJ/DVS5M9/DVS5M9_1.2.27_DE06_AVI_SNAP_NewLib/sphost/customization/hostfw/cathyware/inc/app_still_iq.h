...
typedef cus_tablename_t* (*fpIqCallback_t )(IQ_STATE_t IQState);
typedef fpIqCallback_t appIqCustomCBF_t;
void appIqCustomCBRegister(	appIqCustomCBF_t paeCBF);
UINT32 appIqCustomCBGet(UINT32 iqModeSet);
