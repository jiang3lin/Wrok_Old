...
/*-- LED */
#define IO_LED_MAIN_SET(a) 		dummyio_set
#define LED_MAIN_ON				IO_LED_MAIN_SET(1)
#define LED_MAIN_OFF			IO_LED_MAIN_SET(0)

#define IO_LED_STIMER_SET(a) 	dummyio_set
...
#define IO_LCD_BACKLIGHT_SET(a)	dummyio_set // LCD Backlight IO Control
#define LCD_BACKLIGHT_ON		IO_LCD_BACKLIGHT_SET(1)
#define LCD_BACKLIGHT_OFF		IO_LCD_BACKLIGHT_SET(0)
#define IS_BACKLIGHT_ON              (1)/*EVB not support close back light*/


#define IO_LCD_RESET_SET(a)		dummyio_set // LCD RESET IO Control
