...
void appCdvPbDeleteLoopOsdShow(void)
{
	appLcmOsdClean();
	
	//Mode Icon	
	appLcmOsdLargeIconShow(LcmOsdIconIndex0, ID_ICON_SCDV_DELETE_LOOP, FALSE);
...
void appCdvPbDeleteLoopStateInit(UINT32 preState)
{
	UINT32 mode;
...
void appCdvPbDeleteLoopStateOnMsg(UINT32 msg, UINT32 param)
{
	switch(msg)
	{
...
void appCdvPbDeleteLoopStateOnKey(UINT32 msg, UINT32 param)
{
	switch(msg)
	{
...
void appCdvPbDeleteLoopState(UINT32 msg, UINT32 param)
{
	switch (msg) 
	{
		case APP_STATE_MSG_INIT:
			RPrintf("appSdvPbDeleteState\n");
			appCdvPbDeleteLoopStateInit(appPreviousStateGet());
			break;
		...
		default:
			...
			{
				appCdvPbDeleteLoopStateOnKey(msg,param);
			}
			else
			{
				appCdvPbDeleteLoopStateOnMsg(msg,param);
			}
			break;
	}
}
