...
void appSdvSystemStateInit(UINT32 preState)
{
	UINT32 mode;
	...
	profLogAdd(0,"appSdvSystemStateInit s");
	...
	profLogAdd(0,"appSdvSystemStateInit e");
}

void appSdvSystemStateOnMsg(UINT32 msg, UINT32 param)
{
	switch(msg)
	{
		default:
...
void appSdvSystemStateOnKey(UINT32 msg, UINT32 param)
{
	switch(msg)
	{
...
void appSdvSystemState(UINT32 msg, UINT32 param)
{
	switch (msg) 
	{
		case APP_STATE_MSG_INIT:
			RPrintf("appSdvSystemState\n");
			appSdvSystemStateInit(appPreviousStateGet());
			break;
		...
		default:
			...
			{
				appSdvSystemStateOnKey(msg,param);
			}
			else
			{
				appSdvSystemStateOnMsg(msg,param);
			}
			break;
	}
}
