 ...
 * @date		2008-02-20
 */
#ifndef __APP_UI_PARA_DSC_H__
#define __APP_UI_PARA_DSC_H__
/*
 //=============================================================================
//Header file
//=============================================================================
...
/* ------ Note: Auto create code zone start flag, don't modify or delete this line!!! ------ */
	...
	UINT8 SdvPhotoLapseTime;		/* Auto create code zone, don't modify or delete! */
	...
	UINT8 CdvLoopingTimeSkip;		/* Auto create code zone, don't modify or delete! */
	UINT8 CdvGsensorPowerOn;		/* Auto create code zone, don't modify or delete! */
