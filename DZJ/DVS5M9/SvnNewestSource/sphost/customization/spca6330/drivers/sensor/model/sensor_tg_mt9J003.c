...
#define MODEL_VERSION "$unp_tg_mt9j003-0.00.05"
 ...
 * 0.00.02 vincent,
 *   Add the 1080 mode(1832*1374, 30fps, pixel clock 120MHz),
...
#define PREVIEW_VGA2_HSIZE   848 /* preview horiz. size*/
#define PREVIEW_VGA2_VSIZE   636  /* preview vertical size*/
...
#define PREVIEW_720P60FPS_HSIZE  1280 /* preview horiz. size*/
#define PREVIEW_720P60FPS_VSIZE   720   /* preview vertical size*/


#define CAPTURE_HSIZE  3648/*3648 3664 */	/* capture horiz. size*/
#define CAPTURE_VSIZE  2736/*2736 2748 */	/* capture vertical size*/

/* Preview default definition here */
/*****TODO***multiple preview mode for VGA*/
#define PREVIEW_VGA_LINETOTAL  (2304)/* preview Hd length*/
...
#define PREVIEW_VGA_HOFFSET     1368   	/* preview Hd valid pixel data offset position*/
#define PREVIEW_VGA_VOFFSET     (12)		/* preview Vd valid line data offset position*/
...
#define PREVIEW_VGA_VRESHAPE_FALL        11 /*4*/	/* preview Vd reshap fall*/
#define PREVIEW_VGA_VRESHAPE_RISE         12 /*7*/	/* preview Vd reshap rise*/

/*****TODO***multiple preview mode for VGA2*/
#define PREVIEW_VGA2_LINETOTAL  (2304)/* preview Hd length*/
#define PREVIEW_VGA2_LINEBLANK   6		/* preview Hd sync length*/
#define PREVIEW_VGA2_FRAMETOTAL  686 	/* preview Vd length*/
#define PREVIEW_VGA2_FRAMEBLANK  686	/* preview Vd sync length*/
#define PREVIEW_VGA2_HOFFSET     1368   	/* preview Hd valid pixel data offset position*/
#define PREVIEW_VGA2_VOFFSET     12		/* preview Vd valid line data offset position*/
/* Preview resh_VGA_pe sync signal definition here */
#define PREVIEW_VGA2_HRESHAPE_FALL        1400 	/* preview Hd reshap fall*/
#define PREVIEW_VGA2_HRESHAPE_RISE        1500	/* preview Hd reshap rise*/
#define PREVIEW_VGA2_VRESHAPE_COUNTER_SEL  BY_HD	/* preview Vd reshap control*/
#define PREVIEW_VGA2_VRESHAPE_FALL        11 /*4*/	/* preview Vd reshap fall*/
#define PREVIEW_VGA2_VRESHAPE_RISE         12 /*7*/	/* preview Vd reshap rise*/

#define PREVIEW_1080_LINETOTAL   (1832*2) /* preview Hd length*/
#define PREVIEW_1080_LINEBLANK   6		/* preview Hd sync length*/
#define PREVIEW_1080_FRAMETOTAL  1376    /* preview Vd length*/
#define PREVIEW_1080_FRAMEBLANK  1376	/* preview Vd sync length*/
#define PREVIEW_1080_HOFFSET     1396     /* preview Hd valid pixel data offset position*/
#define PREVIEW_1080_VOFFSET     (12)    /* preview Vd valid line data offset position*/
/* Preview resh_1080_pe sync signal definition here */
#define PREVIEW_1080_HRESHAPE_FALL         1100 	/* preview Hd reshap fall*/
#define PREVIEW_1080_HRESHAPE_RISE          1200	/* preview Hd reshap rise*/
#define PREVIEW_1080_VRESHAPE_COUNTER_SEL  BY_HD	/* preview Vd reshap control*/
#define PREVIEW_1080_VRESHAPE_FALL          11 /*4*/	/* preview Vd reshap fall*/
#define PREVIEW_1080_VRESHAPE_RISE          12 /*7*/	/* preview Vd reshap rise*/
...
#define PREVIEW_720P_VOFFSET     (12)    /* preview Vd valid line data offset position*/
...
#define PREVIEW_720P_VRESHAPE_FALL         11 /*4*/	/* preview Vd reshap fall*/
#define PREVIEW_720P_VRESHAPE_RISE         12 /*7*/	/* preview Vd reshap rise*/

#define PREVIEW_720P60FPS_LINETOTAL   (1280*2) /* preview Hd length*/
#define PREVIEW_720P60FPS_LINEBLANK   6		/* preview Hd sync length*/
#define PREVIEW_720P60FPS_FRAMETOTAL  792    /* preview Vd length*/
#define PREVIEW_720P60FPS_FRAMEBLANK  792	/* preview Vd sync length*/
#define PREVIEW_720P60FPS_HOFFSET     600     /* preview Hd valid pixel data offset position*/
#define PREVIEW_720P60FPS_VOFFSET     (12)    /* preview Vd valid line data offset position*/
/* Preview resh_720P_pe sync signal definition here */
#define PREVIEW_720P60FPS_HRESHAPE_FALL         100 	/* preview Hd reshap fall*/
#define PREVIEW_720P60FPS_HRESHAPE_RISE         200	/* preview Hd reshap rise*/
#define PREVIEW_720P60FPS_VRESHAPE_COUNTER_SEL  BY_HD	/* preview Vd reshap control*/
#define PREVIEW_720P60FPS_VRESHAPE_FALL         11 /*4*/	/* preview Vd reshap fall*/
#define PREVIEW_720P60FPS_VRESHAPE_RISE         12 /*7*/	/* preview Vd reshap rise*/
...
#define CAPTURE_VOFFSET     12    /* capture Vd valid line data offset position*/
...
#define CAPTURE_VRESHAPE_FALL		  11/* capture Vd reshap fall , count by pixel*/
#define CAPTURE_VRESHAPE_RISE		  12/* capture Vd reshap rise , count by pixel*/
...
#define	PREVIEW_1080_CFAPATTERN	BAYER_GRBG          /* BAYER_GRBG, BAYER_RGGB, BAYER_BGGR, BAYER_GBRG,*/
#define PREVIEW_VGA_CFAPATTERN  BAYER_GRBG
#define PREVIEW_VGA2_CFAPATTERN  BAYER_GRBG
#define PREVIEW_720P_CFAPATTERN BAYER_GRBG
#define PREVIEW_720P60FPS_CFAPATTERN BAYER_GRBG
...
#define	PREVIEW_VGA2_HDNUM_FRAME_END	(PREVIEW_VGA2_VOFFSET+PREVIEW_VGA2_VSIZE+1)		/*the rear interrupt line number of the preview new frame*/
#define	PREVIEW_VGA2_HDNUM_CMDPORT	PREVIEW_VGA2_HDNUM_FRAME_END /*400*/ /*the command port interrupt line number of the preview new frame*/

#define	PREVIEW_1080_HDNUM_FRAME_END	2/*(PREVIEW_1080_VOFFSET+PREVIEW_1080_VSIZE+1)	*/	/*the rear interrupt line number of the preview new frame*/
#define	PREVIEW_1080_HDNUM_CMDPORT	 1000/*1300*/ /*the command port interrupt line number of the preview new frame*/
...
#define	PREVIEW_720P60FPS_HDNUM_FRAME_END	(PREVIEW_720P60FPS_VOFFSET+PREVIEW_720P60FPS_VSIZE+1)		/*the rear interrupt line number of the preview new frame*/
#define	PREVIEW_720P60FPS_HDNUM_CMDPORT	 PREVIEW_720P60FPS_HDNUM_FRAME_END /*520*/ /*the command port interrupt line number of the preview new frame*/
...
static void sensorDoFuncPreviewVGA2Begin();
...
/*??? 720P 60FPS setting not verify. should remove samwang@20120131 */
static const UINT8 cmd_720P60FPS_init[][4] SENSOR_SIF1DMA_BUF = {
/*New code*/
#if(1)
	MI_REG(0x0300,0x0003),
	MI_REG(0x0302,0x0002),
	MI_REG(0x0304,0x0002),
	MI_REG(0x0306,0x007A),
	MI_REG(0x0308,0x000C),
	MI_REG(0x030A,0x0004),
	MI_REG(0x3016,0x0121),
#endif
	...
	MI_REG(0x3002,584),
	MI_REG(0x3006,2169),
	MI_REG(0x3040,0x2AC3),
	MI_REG(0x404,16),
	MI_REG(0x34c,1408),
	MI_REG(0x34e,792),
	MI_REG(0x300C,0x06A6),
	MI_REG(0x300A,0x024B),
	MI_REG(0x3010,72),
	/*MI_REG(0x3012,0x048B),*/
	MI_REG(0x3014,522),
	MI_REG(0x3018,0x0000),
...
/*New code*/
#if(1)
	MI_REG(0x0300,0x0003),/*vt_pix_clk_div*/
	MI_REG(0x0302,0x0002),/*vt_sys_clk_div*/
	MI_REG(0x0304,0x0002), /*pre_pll_clk_div*/
	MI_REG(0x0306,0x005A), /*pll_multiplier	*/
	MI_REG(0x0308,0x000C), /*op_sys_clk_div*/
	MI_REG(0x030A,0x0002), /*vt_pix_clk_div*/	
	MI_REG(0x3016,0x0121), 
...
static const UINT8 cmd_vga2_init[][4] SENSOR_SIF1DMA_BUF = {
/*New code*/
	MI_REG( 0x301A, 0x8018), 
	...
	/*PLL setting*/			
	MI_REG(0x0300,0x4),	/*vt_pix_clk_div*/		
	MI_REG(0x0302,0x1),	/*vt_sys_clk_div*/		
	MI_REG(0x0304,0x2),	/*pre_pll_clk_div*/		
	MI_REG(0x0306,0x36),	/*pll_multiplier	*/	
	MI_REG(0x0308,0xC),		
	MI_REG(0x030A,0x1),	/*op_sys_clk_div*/		
	MI_REG(0x3016,0x111),	/*vt_pix_clk_div*/		
	/*Delay = 100	*/		
	/*Array readout*/			
	MI_REG(0x3004,112),	/*x_addr_start	*/	
	MI_REG(0x3008,3561	),/*x_addr_end	*/	
	MI_REG(0x3002,8),	/*y_addr_start		*/
	MI_REG(0x3006,2593),	/*y_addr_end	*/	
	MI_REG(0x3040,0x1C7	),/*read_mode		*/
	/*Subsampling configuration			*/
	MI_REG(0x0400,0x00),	/*scaling_enable	*/	
	MI_REG(0x0404,0x10),	/*scale_m		*/
	MI_REG(0x034c,864	),/*x_output_size	*/	
	MI_REG(0x034e,648	),/*y_output_size		*/
	/*frame and integration time	*/		
	MI_REG(0x300c,1684	),/*line_length_pck		*/
	MI_REG(0x300a,791	),/*frame_length_lines		*/
	MI_REG(0x3012,0x317	),/*coarse_int_time		*/
	MI_REG(0x3014,0x416	),/*fine_int_time		*/
	MI_REG(0x3010,0x9C),	/*fine_correction	*/	
	MI_REG(0x3018,0x0),	/*extra_delay		*/
...
static const UINT8 cmd_1080_init[][4] SENSOR_SIF1DMA_BUF = {
#if(1)
	MI_REG(0x0300,0x0003),
	MI_REG(0x0302,0x0002),
	MI_REG(0x0304,0x0002),
	...
	MI_REG(0x034C,1920),
	MI_REG(0x034E,1080),
	MI_REG(0x300C,0x0CD6),   
	MI_REG(0x300A,1218),    /*30fps*/
	MI_REG(0x3010,0x009C),
	MI_REG(0x3014,0x03F2),
...
/*NO USE*/
static const sensorTgPreviewCfg_t sensorTgPreviewVGA2Cfg = {
	.fpdo = &(const sensorPreviewDo_t) {
		.previewBegin = sensorDoFuncPreviewVGA2Begin,
		.previewShortExp = sensorDoFuncPreviewShortExp,
		.previewLongExpBegin = NULL,
		.previewLongExpFollow = NULL,
		.previewLongExpEnd = NULL,
	...
	.crop = NULL,
	.hsize = PREVIEW_VGA2_HSIZE,
	.vsize = PREVIEW_VGA2_VSIZE,
	.sensor_model = SENSORMODEL,
	.cfa_pattern = PREVIEW_VGA2_CFAPATTERN,
};
...
static const sensorTgPreviewCfg_t sensorTgPreview1080Cfg = {
	...
	.hratio = PREVIEW_1080_HSIZE,/*16:9 sensor*/
	.vratio = PREVIEW_1080_VSIZE,
#endif
	.fps_mhz = 29980000,
	.sensor_pclk = 120000000,
	.sensor_htotal = 3286,
...
static const sensorTgPreviewCfg_t sensorTgPreview720P60FPSCfg = {
	...
	.crop = NULL,
	.hsize = PREVIEW_720P60FPS_HSIZE,
	.vsize = PREVIEW_720P60FPS_VSIZE,
	.sensor_model = SENSORMODEL,
	.cfa_pattern = PREVIEW_720P60FPS_CFAPATTERN,
	.hratio = PREVIEW_720P60FPS_HSIZE,
	.vratio = PREVIEW_720P60FPS_VSIZE,
	.fps_mhz = 60970000,
	.sensor_pclk = 81333333,
	.sensor_htotal = 1528,
	
};

static const sensorTgPreviewCfg_t *sensorTgPreviewCfgTbl[] = {
		&sensorTgPreviewVGACfg, &sensorTgPreview1080Cfg, &sensorTgPreview720PCfg, &sensorTgPreview720P60FPSCfg, &sensorTgPreviewVGACfg, &sensorTgPreviewVGACfg
};
...
static const sensorSyncSigCfg_t sensorSyncSigPreviewVGA2Cfg = {
	.linetotal       = PREVIEW_VGA2_LINETOTAL,
	.lineblank       = PREVIEW_VGA2_LINEBLANK,
	.frametotal      = PREVIEW_VGA2_FRAMETOTAL,
	.frameblank      = PREVIEW_VGA2_FRAMEBLANK,
	.hreshape_fall   = PREVIEW_VGA2_HRESHAPE_FALL,
	.hreshape_rise   = PREVIEW_VGA2_HRESHAPE_RISE,
	.vreshape_fall   = PREVIEW_VGA2_VRESHAPE_FALL,
	.vreshape_rise   = PREVIEW_VGA2_VRESHAPE_RISE,
	.hoffset         = PREVIEW_VGA2_HOFFSET,
	.voffset         = PREVIEW_VGA2_VOFFSET,
	.hsize           = PREVIEW_VGA2_HSIZE,
	.vsize           = PREVIEW_VGA2_VSIZE,
	.lastlinepix     = PREVIEW_VGA2_LINETOTAL,
	.hdvdopos        = 0,
	.conf_totalsync  = 0,
	.conf_hdpol      = 0,
	.conf_vdpol      = 0,
	...
	.conf_vvldbypass = 0,
	.frameblank_base = 0,
	.vreshape_base   = PREVIEW_VGA2_VRESHAPE_COUNTER_SEL,
	.conf_yuvhdpol	 = 0, /*yuvhd just before hdres 0:active low*/
	.conf_yuvvdpol	 = 1, /*yuvvd just before vdres 0:active low*/
	.hdnum_frame_start = PREVIEW_HDNUM_FRAME_START,
	.hdnum_frame_end = PREVIEW_VGA2_HDNUM_FRAME_END,
	.hdnum_cmdport   = PREVIEW_VGA2_HDNUM_CMDPORT,
};
...
static const sensorSyncSigCfg_t sensorSyncSigPreview720P60FPSCfg = {
	.linetotal       = PREVIEW_720P60FPS_LINETOTAL,
	.lineblank       = PREVIEW_720P60FPS_LINEBLANK,
	.frametotal      = PREVIEW_720P60FPS_FRAMETOTAL,
	.frameblank      = PREVIEW_720P60FPS_FRAMEBLANK,
	.hreshape_fall   = PREVIEW_720P60FPS_HRESHAPE_FALL,
	.hreshape_rise   = PREVIEW_720P60FPS_HRESHAPE_RISE,
	.vreshape_fall   = PREVIEW_720P60FPS_VRESHAPE_FALL,
	.vreshape_rise   = PREVIEW_720P60FPS_VRESHAPE_RISE,
	.hoffset         = PREVIEW_720P60FPS_HOFFSET,
	.voffset         = PREVIEW_720P60FPS_VOFFSET,
	.hsize           = PREVIEW_720P60FPS_HSIZE,
	.vsize           = PREVIEW_720P60FPS_VSIZE,
	.lastlinepix     = PREVIEW_720P60FPS_LINETOTAL,
	.hdvdopos        = 0,
	.conf_totalsync  = 0,
	.conf_hdpol      = 0,
	.conf_vdpol      = 0,
	...
	.conf_vvldbypass = 0,
	.frameblank_base = 0,
	.vreshape_base   = PREVIEW_720P60FPS_VRESHAPE_COUNTER_SEL,
	.conf_yuvhdpol	 = 0, /*yuvhd just before hdres 0:active low*/
	.conf_yuvvdpol	 = 0, /*yuvvd just before vdres 0:active low*/
	.hdnum_frame_start = PREVIEW_HDNUM_FRAME_START,
	.hdnum_frame_end = PREVIEW_720P60FPS_HDNUM_FRAME_END,
	.hdnum_cmdport   = PREVIEW_720P60FPS_HDNUM_CMDPORT,
};
...
sensorReportsize()
{
	PROF_LOG_PRINT(1,"mclkdiv   cdspclkdiv  = (%d,%d)",READ8(0xb0000082),READ8(0xb0000083));
	PROF_LOG_PRINT(1,"front output size     = (%d,%d)",READ16(0xb00090CC),READ16(0xb00090CE));
	PROF_LOG_PRINT(1,"imgsource output size = (%d,%d)",READ16(0xb0002088),READ16(0xb000208A));
	PROF_LOG_PRINT(1,"rgbhscale output size = (%d,%d)",READ16(0xb000208C),READ16(0xb000208E));
	PROF_LOG_PRINT(1,"rawmux output size    = (%d,%d)",READ16(0xb0002090),READ16(0xb0002092));
}
#endif
...
sensorDoFuncPreviewVGA2Begin()
{
  ...
  /*serial port has fw sync mechanism, do it here instead of after vvalid*/
	...
	fpssg(&sensorSyncSigPreviewVGA2Cfg);
	sensorDsenExtSet();
#if HAS_STREAM_OFF
	if (!is_aborted)
#endif
	sensorStreamOff();
	sensorSerialAsyncWrite(cmdportid,
			sizeof(cmd_vga2_init) / sizeof(cmd_vga2_init[0]),
			cmd_vga2_init[0]);
#if HAS_STREAM_OFF
	if (is_aborted) {
		sensorSerialFlush(cmdportid);
	...
	PROF_LOG_ADD(1, "HiSPi vga2 done");
...
sensorDoFuncPreview1080Begin()
{
	...
	fpssg(&sensorSyncSigPreview1080Cfg);
	...
	sensorStreamOff();
	sensorSerialAsyncWrite(cmdportid,
			sizeof(cmd_1080_init) / sizeof(cmd_1080_init[0]),
			cmd_1080_init[0]);
#if HAS_STREAM_OFF
	if (is_aborted) {
		sensorSerialFlush(cmdportid);
	...
	PROF_LOG_ADD(1, "HiSPi 1080 done");
}
...
sensorDoFuncPreview720P60FPSBegin()
{
  ...
  /*serial port has fw sync mechanism, do it here instead of after vvalid*/
	...
	profLogAdd(1,"cmd_720P60FPS_init");
	...
	fpssg(&sensorSyncSigPreview720P60FPSCfg);
	sensorDsenExtSet();
#if HAS_STREAM_OFF
	if (!is_aborted)
#endif
	sensorStreamOff();
	sensorSerialAsyncWrite(cmdportid,
			sizeof(cmd_720P60FPS_init)/sizeof(cmd_720P60FPS_init[0]),
			cmd_720P60FPS_init[0]);
#if HAS_STREAM_OFF
	if (is_aborted) {
		sensorSerialFlush(cmdportid);
		sensor_mode_abort_stream_on();
	...
	PROF_LOG_ADD(1, "HiSPi 720P60FPS done");
...
sensorDoFuncSnapExpBegin()
{
	...
	earlyHdCfg.hdnum_cmdport=200 /*PREVIEW_1080_HDNUM_CMDPORT*/;
	earlyHdCfg.hdnum_frame_end=625 /*PREVIEW_1080_HDNUM_FRAME_END*/;
	...
	fpssg(&sensorSyncSigSnapCfg);
		...
		#if MODE9_DESENSOR_TEST


	    *(volatile UINT8 *)0xb0002271 = 0x00;
		*(volatile UINT16 *)0xb0002272 = (CAPTURE_HSIZE/2);/*0x10;*/
		*(volatile UINT16 *)0xb0002276 = 0x40;
		*(volatile UINT16 *)0xb0002278 = CAPTURE_HSIZE;
		*(volatile UINT8 *)0xb000227F = 0x01;
		*(volatile UINT8 *)0xb0002270 = 0x91;
...
#if 0	
		WRITE8(0xb0000082,0x01);/* masterclkDIV  */
		WRITE8(0xb0000083,0x01);/* cdspclkDIV     */
#endif		
		WRITE8(0xb0002004,0x10);
		#else
		sensorDsenExtSet();
		*(volatile UINT8 *)0xb000227F = 0x01;
		*(volatile UINT8 *)0xb0002004 = 0x10;
		#endif

#if 0 /*Disable Display*/
	 	WRITE8(0xb00070F5,0x00);
...
sensorDoFuncSnapReadoutField0()
{
	...
	static sensorSyncSigHdnumCfg_t earlyHdCfg = {
		.hdnum_frame_start=PREVIEW_HDNUM_FRAME_START,
		.hdnum_frame_end=625 /*PREVIEW_1080_HDNUM_FRAME_END*/,
		.hdnum_cmdport=200 /*PREVIEW_1080_HDNUM_CMDPORT*/,
	}
	sensorSyncSigHdnumSet(&earlyHdCfg);
#endif
}
