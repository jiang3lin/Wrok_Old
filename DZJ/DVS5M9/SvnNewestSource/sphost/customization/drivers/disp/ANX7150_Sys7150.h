...
#define i2c_read_p1_reg  ANX7150_i2c_read_p1_reg
#define i2c_read_p0_reg  ANX7150_i2c_read_p0_reg
...
#define ANX7150_DBG_NULL_FUNC	do {} while(0)
#define ANX7150_debug 1
#if ANX7150_debug
#define debug_puts   printf 
#define debug_printf  printf 

#else

#define debug_puts(str, arg...)    ANX7150_DBG_NULL_FUNC /*printf */
#define debug_printf(str, arg...)   ANX7150_DBG_NULL_FUNC /*printf */
...
extern BYTE ANX7150_system_state;
extern BIT ANX7150_srm_checked;
extern BIT ANX7150_HDCP_enable;
extern BIT ANX7150_INT_Done;
extern BYTE FREQ_MCLK;
extern BYTE int_s1, int_s2, int_s3;
...
typedef struct 
{
    ...
    BYTE supported_1080p_60Hz;
    BYTE supported_1080p_50Hz;
    ...
    BYTE AudioFs[10];
    BYTE AudioLength[10];
    BYTE SpeakerFormat;BYTE edid_errcode;}ANX7150_edid_result_4_system;
    extern ANX7150_edid_result_4_system ANX7150_edid_result;
/*#define ITU656*/
/*#ifdef ITU656*/
struct ANX7150_video_timingtype{ /*CEA-861C format*/
    BYTE ANX7150_640x480p_60Hz[18];/*format 1*/
    BYTE ANX7150_720x480p_60Hz[18];/*format 2 & 3*/
    BYTE ANX7150_1280x720p_60Hz[18];/*format 4*/
    BYTE ANX7150_1920x1080i_60Hz[18];/*format 5*/
    BYTE ANX7150_720x480i_60Hz[18];/*format 6 & 7*/
    ...
    BYTE ANX7150_720x576p_50Hz[18];/*format 17 & 18*/
    BYTE ANX7150_1280x720p_50Hz[18];/*format 19*/
    BYTE ANX7150_1920x1080i_50Hz[18];/*format 20*/
    BYTE ANX7150_720x576i_50Hz[18];/*format 21 & 22*/
...
typedef struct
{
    ...
    BYTE down_sample;     /* 0x72:0x50*/
                                ...
                                /* 0x40:    10  reserved*/
     BYTE audio_layout;/*audio layout; */
     								/*0x00, 2-channel*/
     								/*0x80, 8-channel*/
...
extern BIT ANX7150_parse_edid_done;
extern BIT ANX7150_system_config_done;
extern BYTE ANX7150_video_format_config,ANX7150_video_timing_id;
extern BIT ANX7150_new_csc,ANX7150_new_vid_id,ANX7150_new_HW_interface;
extern BIT ANX7150_ddr_edge;
extern BYTE ANX7150_in_pix_rpt_bkp,ANX7150_tx_pix_rpt_bkp;
extern BYTE ANX7150_in_pix_rpt,ANX7150_tx_pix_rpt;
extern BIT ANX7150_pix_rpt_set_by_sys;
extern BYTE ANX7150_RGBorYCbCr;
extern audio_config_struct s_ANX7150_audio_config;
extern config_packets s_ANX7150_packet_config;
extern BIT ANX7150_app_hold_system_config;
extern BIT ANX7150_shutdown;
/********************** BIST Enable***********************************/
#define BIST_MODE_USED 0
#define ANX8770_USED 0
#define rpt_auto_setting 0
#define rpt_manual_setting 1
...
#define ANX7150_SRST_AFIFO_RST	       	 0x10	
#define ANX7150_SRST_HDCP_RST		        0x08	
#define ANX7150_SRST_VID_FIFO_RST		 0x04	
#define ANX7150_SRST_AUD_RST		 0x02	
#define ANX7150_SRST_SW_RST			 0x01	

#define ANX7150_SYS_STATE_REG 0x06
#define ANX7150_SYS_STATE_AUD_CLK_DET	        0x20	
#define ANX7150_SYS_STATE_AVMUTE	       	 0x10	
#define ANX7150_SYS_STATE_HP		       	 0x08	
#define ANX7150_SYS_STATE_VSYNC		 		 0x04	
#define ANX7150_SYS_STATE_CLK_DET		 	 0x02	
#define ANX7150_SYS_STATE_RSV_DET			 0x01	

#define ANX7150_SYS_CTRL1_REG 0x07
#define ANX7150_SYS_CTRL1_LINKMUTE_EN	        0x80	
#define ANX7150_SYS_CTRL1_HDCPHPD_RST		 0x40	
#define ANX7150_SYS_CTRL1_PDINT_SEL		 0x20	
#define ANX7150_SYS_CTRL1_DDC_FAST	        	 0x10	
#define ANX7150_SYS_CTRL1_DDC_SWCTRL	        0x08	
#define ANX7150_SYS_CTRL1_HDCPMODE		 0x04	
#define ANX7150_SYS_CTRL1_HDMI				 0x02	
#define ANX7150_SYS_CTRL1_PWDN_CTRL	        0x01	

#define ANX7150_SYS_CTRL2_REG 0x08
#define ANX7150_SYS_CTRL2_DDC_RST	      		  0x08	
#define ANX7150_SYS_CTRL2_TMDSBIST_RST	  0x04	
#define ANX7150_SYS_CTRL2_MISC_RST		 	  0x02	
#define ANX7150_SYS_CTRL2_HW_RST	     		  0x01	
...
#define ANX7150_VID_STATUS_VID_STABLE		 0x20	
#define ANX7150_VID_STATUS_EMSYNC_ERR	        0x10	
#define ANX7150_VID_STATUS_FLD_POL	    		 0x08	
#define ANX7150_VID_STATUS_TYPE		 	 0x04	
#define ANX7150_VID_STATUS_VSYNC_POL		 0x02	
#define ANX7150_VID_STATUS_HSYNC_POL	        0x01	

#define ANX7150_VID_MODE_REG 0x11
#define ANX7150_VID_MODE_CHKSHARED_EN	 0x80	
#define ANX7150_VID_MODE_LINKVID_EN		 0x40	
#define ANX7150_VID_MODE_RANGE_Y2R		 0x20	
#define ANX7150_VID_MODE_CSPACE_Y2R	        0x10	
#define ANX7150_VID_MODE_Y2R_SEL	        	 0x08	
#define ANX7150_VID_MODE_UPSAMPLE			 0x04	

#define ANX7150_VID_CTRL_REG  0x12
#define ANX7150_VID_CTRL_IN_EN	    		 0x10	
#define ANX7150_VID_CTRL_YCBIT_SEL        	 0x08	
#define ANX7150_VID_CTRL_BITCTRL_EN	 		0x04	

#define ANX7150_VID_CAPCTRL0_REG  0x13
#define ANX7150_VID_CAPCTRL0_DEGEN_EN	 	 0x80	
#define ANX7150_VID_CAPCTRL0_EMSYNC_EN	 0x40	
#define ANX7150_VID_CAPCTRL0_DEMUX_EN		 0x20	
#define ANX7150_VID_CAPCTRL0_INV_IDCK	        0x10	
#define ANX7150_VID_CAPCTRL0_DV_BUSMODE	 0x08	
#define ANX7150_VID_CAPCTRL0_DDR_EDGE		 0x04	
#define ANX7150_VID_CAPCTRL0_VIDBIT_SWAP	 0x02	
#define ANX7150_VID_CAPCTRL0_VIDBIST_EN	 0x01	
	
#define ANX7150_VID_CAPCTRL1_REG 0x14
#define ANX7150_VID_CAPCTRL1_FORMAT_SEL	 	 0x80	
#define ANX7150_VID_CAPCTRL1_VSYNC_POL	   	 0x40	
#define ANX7150_VID_CAPCTRL1_HSYNC_POL		 0x20	
#define ANX7150_VID_CAPCTRL1_INV_FLDPOL	        0x10	
#define ANX7150_VID_CAPCTRL1_VID_TYPE	 		0x08	
...
#define ANX7150_INTR_CTRL_SOFT_INTR	 0x04	
#define ANX7150_INTR_CTRL_TYPE			 0x02	
#define ANX7150_INTR_CTRL_POL	 		 0x01	

#define ANX7150_INTR1_STATUS_REG 0x42
#define ANX7150_INTR1_STATUS_CTS_CHG 	 	 0x80	
#define ANX7150_INTR1_STATUS_AFIFO_UNDER	 0x40	
#define ANX7150_INTR1_STATUS_AFIFO_OVER	 0x20	
#define ANX7150_INTR1_STATUS_SPDIF_ERR	        0x10	
#define ANX7150_INTR1_STATUS_SW_INT	 	0x08	
#define ANX7150_INTR1_STATUS_HP_CHG		 0x04	
#define ANX7150_INTR1_STATUS_CTS_OVRWR	 	0x02	
#define ANX7150_INTR1_STATUS_CLK_CHG		 0x01	

#define ANX7150_INTR2_STATUS_REG 0x43
#define ANX7150_INTR2_STATUS_ENCEN_CHG 	 	0x80	
#define ANX7150_INTR2_STATUS_HDCPLINK_CHK	 	0x40	
#define ANX7150_INTR2_STATUS_HDCPENHC_CHK 	0x20	
#define ANX7150_INTR2_STATUS_BKSV_RDY		        0x10	
#define ANX7150_INTR2_STATUS_PLLLOCK_CHG	 	0x08	
#define ANX7150_INTR2_STATUS_SHA_DONE			 0x04	
#define ANX7150_INTR2_STATUS_AUTH_CHG	 		0x02	
#define ANX7150_INTR2_STATUS_AUTH_DONE		 0x01	

#define ANX7150_INTR3_STATUS_REG 0x44
#define ANX7150_INTR3_STATUS_SPDIFBI_ERR 	 	0x80	
#define ANX7150_INTR3_STATUS_VIDF_CHG	 		0x40	
#define ANX7150_INTR3_STATUS_AUDCLK_CHG 		0x20	
#define ANX7150_INTR3_STATUS_DDCACC_ERR	        0x10	
#define ANX7150_INTR3_STATUS_DDC_NOACK	 	0x08	
#define ANX7150_INTR3_STATUS_VSYNC_DET		 0x04	
#define ANX7150_INTR3_STATUS_RXSEN_CHG		0x02	
#define ANX7150_INTR3_STATUS_SPDIF_UNSTBL		 0x01	
...
#define ANX7150_HDMI_AUDCTRL0_LAYOUT 	 	0x80	
#define ANX7150_HDMI_AUDCTRL0_DOWN_SMPL 	0x60	
#define ANX7150_HDMI_AUDCTRL0_CTSGEN_SC 	 	0x10	
#define ANX7150_HDMI_AUDCTRL0_INV_AUDCLK 	 	0x08	

#define ANX7150_HDMI_AUDCTRL1_REG 0x51
#define ANX7150_HDMI_AUDCTRL1_IN_EN 	 		0x80	
#define ANX7150_HDMI_AUDCTRL1_SPDIFIN_EN	 	0x40	
#define ANX7150_HDMI_AUDCTRL1_SD3IN_EN		0x20	
#define ANX7150_HDMI_AUDCTRL1_SD2IN_EN	        0x10	
#define ANX7150_HDMI_AUDCTRL1_SD1IN_EN	 	0x08	
#define ANX7150_HDMI_AUDCTRL1_SD0IN_EN		 0x04	
#define ANX7150_HDMI_AUDCTRL1_SPDIFFS_OVRWR	0x02	
#define ANX7150_HDMI_AUDCTRL1_CLK_SEL		 0x01	

#define ANX7150_I2S_CTRL_REG 0x52
#define ANX7150_I2S_CTRL_VUCP 	 		0x80	
#define SPDIF_IN_SEL 0x10 /*0-spdif, 1-multi with sd0*/
#define ANX7150_I2S_CTRL_SHIFT_CTRL	 	0x08	
#define ANX7150_I2S_CTRL_DIR_CTRL		 0x04	
#define ANX7150_I2S_CTRL_WS_POL		0x02	
#define ANX7150_I2S_CTRL_JUST_CTRL		 0x01	

#define ANX7150_I2SCH_CTRL_REG 0x53
#define ANX7150_I2SCH_FIFO3_SEL	 	0xC0	
#define ANX7150_I2SCH_FIFO2_SEL	 0x30	
#define ANX7150_I2SCH_FIFO1_SEL	 0x0C	
#define ANX7150_I2SCH_FIFO0_SEL	 0x03	

#define ANX7150_I2SCH_SWCTRL_REG 0x54

#define ANX7150_I2SCH_SWCTRL_SW3 	 		0x80	
#define ANX7150_I2SCH_SWCTRL_SW2	 	0x40	
#define ANX7150_I2SCH_SWCTRL_SW1		0x20	
#define ANX7150_I2SCH_SWCTRL_SW0	        0x10	
#define ANX7150_I2SCH_SWCTRL_INWD_LEN		0xE0	
#define ANX7150_I2SCH_SWCTRL_INWD_MAX		 0x01	

#define ANX7150_SPDIFCH_STATUS_REG 0x55
#define ANX7150_SPDIFCH_STATUS_FS_FREG	0xF0	
#define ANX7150_SPDIFCH_STATUS_WD_LEN 0x0E	
#define ANX7150_SPDIFCH_STATUS_WD_MX 0x01	

#define ANX7150_I2SCH_STATUS1_REG 0x56
#define ANX7150_I2SCH_STATUS1_MODE	 0xC0	
#define ANX7150_I2SCH_STATUS1_PCM_MODE	 0x38	
#define ANX7150_I2SCH_STATUS1_SW_CPRGT	 0x04	
#define ANX7150_I2SCH_STATUS1_NON_PCM	0x02	
#define ANX7150_I2SCH_STATUS1_PROF_APP	 0x01	

#define ANX7150_I2SCH_STATUS2_REG 0x57

#define ANX7150_I2SCH_STATUS3_REG 0x58
#define ANX7150_I2SCH_STATUS3_CH_NUM	0xF0	
#define ANX7150_I2SCH_STATUS3_SRC_NUM	0x0F	
...
#define ANX7150_I2SCH_STATUS5_WORD_MAX 0x01	

#define ANX7150_HDMI_AUDSTATUS_REG 0x5B

#define ANX7150_HDMI_AUDSTATUS_SPDIF_DET 0x01	

#define ANX7150_HDMI_AUDBIST_CTRL_REG 0x5C

#define ANX7150_HDMI_AUDBIST_EN3	 	0x08	
#define ANX7150_HDMI_AUDBIST_EN2		 0x04	
#define ANX7150_HDMI_AUDBIST_EN1		0x02	
#define ANX7150_HDMI_AUDBIST_EN0		 0x01	
...
#define ANX7150_ONEBIT_AUD_CTRL_SEN7 	 	0x80	
#define ANX7150_ONEBIT_AUD_CTRL_SEN6	 	0x40	
#define ANX7150_ONEBIT_AUD_CTRL_SEN5		0x20	
#define ANX7150_ONEBIT_AUD_CTRL_SEN4	    0x10	
#define ANX7150_ONEBIT_AUD_CTRL_SEN3	 	0x08	
#define ANX7150_ONEBIT_AUD_CTRL_SEN2		0x04	
#define ANX7150_ONEBIT_AUD_CTRL_SEN1		0x02	
#define ANX7150_ONEBIT_AUD_CTRL_SEN0		0x01	
...
#define ANX7150_ONEBIT_AUDCLK_DET 	0x08	
...
#define ANX7150_HDMI_LINK_DATA_MUTEEN1 	 	0x80	
#define ANX7150_HDMI_LINK_DATA_MUTEEN0	 	0x40	
#define ANX7150_HDMI_LINK_CLK_MUTEEN2		0x20	
#define ANX7150_HDMI_LINK_CLK_MUTEEN1	    0x10	
#define ANX7150_HDMI_LINK_CLK_MUTEEN0	 	0x08	
#define ANX7150_HDMI_LINK_DEC_DE			0x04	
#define ANX7150_HDMI_LINK_PRMB_INC			0x02	
#define ANX7150_HDMI_LINK_AUTO_PROG			0x01	

#define ANX7150_VID_CAPCTRL2_REG  0x71

#define ANX7150_VID_CAPCTRL2_CHK_UPDATEEN    0x10	

#define ANX7150_LINK_MUTEEE_REG 0x72

#define ANX7150_LINK_MUTEEE_AVMUTE_EN2		0x20	
#define ANX7150_LINK_MUTEEE_AVMUTE_EN1	    0x10	
#define ANX7150_LINK_MUTEEE_AVMUTE_EN0	 	0x08	
#define ANX7150_LINK_MUTEEE_AUDMUTE_EN2		0x04	
#define ANX7150_LINK_MUTEEE_AUDMUTE_EN1		0x02	
#define ANX7150_LINK_MUTEEE_AUDMUTE_EN0		0x01	
...
#define ANX7150_DDC_CHSTATUS_DDCERR	 	0x80	
#define ANX7150_DDC_CHSTATUS_DDC_OCCUPY	 	0x40	
#define ANX7150_DDC_CHSTATUS_FIFO_FULL		0x20	
#define ANX7150_DDC_CHSTATUS_FIFO_EMPT	    0x10	
#define ANX7150_DDC_CHSTATUS_NOACK	 	0x08	
#define ANX7150_DDC_CHSTATUS_FIFO_RD			0x04	
#define ANX7150_DDC_CHSTATUS_FIFO_WR			0x02	
#define ANX7150_DDC_CHSTATUS_INPRO			0x01	

#define ANX7150_DDC_FIFO_ACC_REG 0x87
#define ANX7150_DDC_FIFOCNT_REG 0x88

#define ANX7150_SYS_PD_REG 0x90
#define ANX7150_SYS_PD_PLL 	 	0x80	
#define ANX7150_SYS_PD_TMDS	 	0x40	
#define ANX7150_SYS_PD_TMDS_CLK		0x20	
#define ANX7150_SYS_PD_MISC	    0x10	
#define ANX7150_SYS_PD_LINK	 	0x08	
#define ANX7150_SYS_PD_IDCK			0x04	
#define ANX7150_SYS_PD_AUD			0x02	
#define ANX7150_SYS_PD_MACRO_ALL	0x01	

#define ANX7150_LINKFSM_DEBUG0_REG 0x91
#define ANX7150_LINKFSM_DEBUG1_REG 0x92

#define ANX7150_PLL_CTRL0_REG 0x93
#define ANX7150_PLL_CTRL0_CPREG_BLEED			0x02	
#define ANX7150_PLL_CTRL0_TEST_EN	0x01	

#define ANX7150_PLL_CTRL1_REG 0x94
#define ANX7150_PLL_CTRL1_TESTEN 	 	0x80	

#define ANX7150_OSC_CTRL_REG 0x95
#define ANX7150_OSC_CTRL_TESTEN	 	0x80	
#define ANX7150_OSC_CTRL_SEL_BG	 	0x40	

#define ANX7150_TMDS_CH0_CONFIG_REG 0x96
#define ANX7150_TMDS_CH0_TESTEN		0x20	
#define ANX7150_TMDS_CH0_AMP		0x1C	
#define ANX7150_TMDS_CHO_EMP		0x03	

#define ANX7150_TMDS_CH1_CONFIG_REG 0x97
#define ANX7150_TMDS_CH1_TESTEN		0x20	
#define ANX7150_TMDS_CH1_AMP		0x1C	
#define ANX7150_TMDS_CH1_EMP		0x03	

#define ANX7150_TMDS_CH2_CONFIG_REG 0x98
#define ANX7150_TMDS_CH2_TESTEN		0x20	
#define ANX7150_TMDS_CH2_AMP		0x1C	
#define ANX7150_TMDS_CH2_EMP		0x03	

#define ANX7150_TMDS_CLKCH_CONFIG_REG 0x99
#define ANX7150_TMDS_CLKCH_MUTE	 	0x80	
#define ANX7150_TMDS_CLKCH_TESTEN	0x08	
#define ANX7150_TMDS_CLKCH_AMP		0x07	

#define ANX7150_CHIP_CTRL_REG 0x9A
#define ANX7150_CHIP_CTRL_PRBS_GENEN 	 	0x80	
#define ANX7150_CHIP_CTRL_LINK_DBGSEL	 	0x70	
#define ANX7150_CHIP_CTRL_VIDCHK_EN		 	0x08	
#define ANX7150_CHIP_CTRL_MISC_TIMER		0x04	
#define ANX7150_CHIP_CTRL_PLL_RNG		0x02	
#define ANX7150_CHIP_CTRL_PLL_MAN		0x01	

#define ANX7150_CHIP_STATUS_REG 0x9B
#define ANX7150_CHIP_STATUS_GPIO	 	0x80	
#define ANX7150_CHIP_STATUS_SDA	 		0x40	
#define ANX7150_CHIP_STATUS_SCL			0x20	
#define ANX7150_CHIP_STATUS_PLL_HSPO	0x04	
#define ANX7150_CHIP_STATUS_PLL_LOCK	0x02	
#define ANX7150_CHIP_STATUS_MISC_LOCK	0x01	

#define ANX7150_DBG_PINGPIO_CTRL_REG  0x9C
#define ANX7150_DBG_PINGPIO_VDLOW_SHAREDEN		0x04	
#define ANX7150_DBG_PINGPIO_GPIO_ADDREN			0x02	
#define ANX7150_DBG_PINGPIO_GPIO_OUT			0x01	

#define ANX7150_CHIP_DEBUG0_CTRL_REG  0x9D
#define ANX7150_CHIP_DEBUG0_PRBS_ERR 0xE0		
#define ANX7150_CHIP_DEBUG0_CAPST  	 0x1F		

#define ANX7150_CHIP_DEBUG1_CTRL_REG  0x9E
#define ANX7150_CHIP_DEBUG1_SDA_SW 	 	0x80	
#define ANX7150_CHIP_DEBUG1_SCL_SW	 	0x40	
#define ANX7150_CHIP_DEBUG1_SERDES_TESTEN		0x20	
#define ANX7150_CHIP_DEBUG1_CLK_BYPASS	    0x10	
#define ANX7150_CHIP_DEBUG1_FORCE_PLLLOCK	 	0x08	
#define ANX7150_CHIP_DEBUG1_PLLLOCK_BYPASS			0x04	
#define ANX7150_CHIP_DEBUG1_FORCE_HP			0x02	
#define ANX7150_CHIP_DEBUG1_HP_DEGLITCH			0x01	

#define ANX7150_CHIP_DEBUG2_CTRL_REG  0x9F
#define ANX7150_CHIP_DEBUG2_EXEMB_SYNCEN		0x04	
#define ANX7150_CHIP_DEBUG2_VIDBIST			0x02	

#define ANX7150_VID_INCLK_REG  0x5F

#define ANX7150_HDCP_STATUS_REG  0xA0
#define ANX7150_HDCP_STATUS_ADV_CIPHER 	 	0x80	
#define ANX7150_HDCP_STATUS_R0_READY	    0x10	
#define ANX7150_HDCP_STATUS_AKSV_ACT	 	0x08	
#define ANX7150_HDCP_STATUS_ENCRYPT			0x04	
#define ANX7150_HDCP_STATUS_AUTH_PASS			0x02	
#define ANX7150_HDCP_STATUS_KEY_DONE			0x01	

#define ANX7150_HDCP_CTRL0_REG  0xA1
#define ANX7150_HDCP_CTRL0_STORE_AN 	 	0x80	
#define ANX7150_HDCP_CTRL0_RX_REP	 	0x40	
#define ANX7150_HDCP_CTRL0_RE_AUTH		0x20	
#define ANX7150_HDCP_CTRL0_SW_AUTHOK	    0x10	
#define ANX7150_HDCP_CTRL0_HW_AUTHEN	 	0x08	
#define ANX7150_HDCP_CTRL0_ENC_EN			0x04	
#define ANX7150_HDCP_CTRL0_BKSV_SRM			0x02	
#define ANX7150_HDCP_CTRL0_KSV_VLD			0x01	

#define ANX7150_HDCP_CTRL1_REG  0xA2
#define ANX7150_LINK_CHK_12_EN  0x40
#define ANX7150_HDCP_CTRL1_DDC_NOSTOP		0x20	
#define ANX7150_HDCP_CTRL1_DDC_NOACK	    0x10	
#define ANX7150_HDCP_CTRL1_EDDC_NOACK	 	0x08	
#define ANX7150_HDCP_CTRL1_BLUE_SCREEN_EN			0x04	
#define ANX7150_HDCP_CTRL1_RCV11_EN			0x02	
#define ANX7150_HDCP_CTRL1_HDCP11_EN			0x01	
...
#define ANX7150_HDCP_DBG_ENC_INC 	0x08	
#define ANX7150_HDCP_DBG_DDC_SPEED	0x06	
#define ANX7150_HDCP_DBG_SKIP_RPT	0x01	

#define ANX7150_HDCP_KEY_STATUS_REG  0xBE
#define ANX7150_HDCP_KEY_BIST_EN	0x04	
#define ANX7150_HDCP_KEY_BIST_ERR	0x02	
#define ANX7150_HDCP_KEY_CMD_DONE	0x01	

#define ANX7150_KEY_CMD_REGISTER 0xBF   
...
#define ANX7150_INFO_PKTCTRL1_SPD_RPT 	 	0x80	
#define ANX7150_INFO_PKTCTRL1_SPD_EN	 	0x40	
#define ANX7150_INFO_PKTCTRL1_AVI_RPT		0x20	
#define ANX7150_INFO_PKTCTRL1_AVI_EN	    0x10	
#define ANX7150_INFO_PKTCTRL1_GCP_RPT	 	0x08	
#define ANX7150_INFO_PKTCTRL1_GCP_EN		0x04	
#define ANX7150_INFO_PKTCTRL1_ACR_NEW		0x02	
#define ANX7150_INFO_PKTCTRL1_ACR_EN		0x01	

#define ANX7150_INFO_PKTCTRL2_REG  0xC1
#define ANX7150_INFO_PKTCTRL2_UD1_RPT 	 	0x80	
#define ANX7150_INFO_PKTCTRL2_UD1_EN	 	0x40	
#define ANX7150_INFO_PKTCTRL2_UD0_RPT		0x20	
#define ANX7150_INFO_PKTCTRL2_UD0_EN	    0x10	
#define ANX7150_INFO_PKTCTRL2_MPEG_RPT	 	0x08	
#define ANX7150_INFO_PKTCTRL2_MPEG_EN		0x04	
#define ANX7150_INFO_PKTCTRL2_AIF_RPT		0x02	
#define ANX7150_INFO_PKTCTRL2_AIF_EN		0x01	
...
#define ANX7150_GNRL_CTRL_CLR_AVMUTE		0x02	
#define ANX7150_GNRL_CTRL_SET_AVMUTE		0x01	

#define ANX7150_AUD_PKT_FLATCTRL_REG  0xCD
#define ANX7150_AUD_PKT_AUTOFLAT_EN 		0x80	
#define ANX7150_AUD_PKT_FLAT 	 			0x07	
...
void ANX7150_Hardware_Reset(void);
...
BYTE ANX7150_Parse_ExtBlock(void);
void ANX7150_GetEDIDLength(void);
void ANX7150_EDID_Parsing_Result(void);
BYTE ANX7150_EDID_Checksum(BYTE block_number) ;
void ANX7150_InitDDC_Read(BYTE devaddr, BYTE segmentpointer,BYTE offset, BYTE  access_num_Low,BYTE access_num_high);
...
BYTE ANX7150_DDC_Check_Status(ANX7150_DDC_Status_Check_Type DDC_status_need_type, BYTE status_bit);
BYTE ANX7150_DDC_Count_Compare(BYTE length);
BYTE ANX7150_DDC_Read(ANX7150_DDC_Addr ddc_address,BYTE *DDC_data, WORD length, ANX7150_DDC_Type DDC_type);
/*BYTE ANX7150_DDC_Write(ANX7150_DDC_Addr ddc_address, const BYTE *DDC_data, WORD length, ANX7150_DDC_Type DDC_type);*/
/*end*/
...
#if 1
/*void ANX7150_BIST();*/
/*void ANX7150_Config_Bist_Video_RefreshF(BYTE switch_value);*/
...
/*void ANX7150_IS_KSVFIFO_Ready(void);*/
/*BYTE ANX7150_Check_KSV_SRM(void);*/
void ANX7150_Task();
/*
void ANX7150_i2c_read(UINT8 regaddr,UINT8  *pregdata, UINT8  cnt,UINT8  mode, UINT8  sync);
*/
