...
/* device open. */
#if  1
#define dispOpen        dispAnaAnx7150Open
#define dispOpPowerOn   dispAnaAnx7150OpPowerOn
#define dispOpPowerOff  dispAnaAnx7150OpPowerOff
#endif
...
/* device name. */
static  UINT8 dispDevName[] = "HDMI - ANA ANX7150";
...
)
{
	...
	WRITE8(0xb000a130,0x0c);  /* hsync vsync polarity inverter */
...
void ANX7150_i2c_read_p0_reg(BYTE offset, BYTE *d)
{
	...
	regdata[0]=regdata[0]; /* clean warning */
	regaddr[0]= offset;
