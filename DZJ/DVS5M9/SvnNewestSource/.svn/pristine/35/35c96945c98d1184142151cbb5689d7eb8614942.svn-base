 ...
 * @date		2008-02-20
 */
#ifndef __APP_UI_PARA_DVS5M2_H__
#define __APP_UI_PARA_DVS5M2_H__
/*
 //=============================================================================
//Header file
//=============================================================================
...
/* ------ Note: Auto create code zone start flag, don't modify or delete this line!!! ------ */
	...
	UINT8 SdvVideoMode;		/* Auto create code zone, don't modify or delete! */
	UINT8 SdvVideoNormalSize;		/* Auto create code zone, don't modify or delete! */
	UINT8 SdvVideoSlowTime;		/* Auto create code zone, don't modify or delete! */
	UINT8 SdvPhotoMode;		/* Auto create code zone, don't modify or delete! */
	UINT8 SdvPhotoNormalSize;		/* Auto create code zone, don't modify or delete! */
	UINT8 SdvPhotoBurstNumber;		/* Auto create code zone, don't modify or delete! */
	UINT8 SdvPhotoSelfTimer;		/* Auto create code zone, don't modify or delete! */
	UINT8 SCdvSensorFlip;		/* Auto create code zone, don't modify or delete! */
	UINT8 CdvVideoMode;		/* Auto create code zone, don't modify or delete! */
	UINT8 CdvVideoNormalSize;		/* Auto create code zone, don't modify or delete! */
	UINT8 CdvVideoLapseTime;		/* Auto create code zone, don't modify or delete! */
	UINT8 CdvLoopingTime;		/* Auto create code zone, don't modify or delete! */
	UINT8 CdvGsensorTrigger;		/* Auto create code zone, don't modify or delete! */
	UINT8 CdvGsensorSensitivity;		/* Auto create code zone, don't modify or delete! */
	UINT8 CdvMicPhone;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemDis;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemWdr;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemLedIndicator;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemOsdFlip;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemOsdBrightness;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemBeepVolume;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemDateStamp;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemAutoPowerOff;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemDateTimeDay;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemDateTimeMonth;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemDateTimeYear;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemDateTimeHour;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemDateTimeMinute;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemDateTimeSecond;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemRemoter;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemFrequnecy;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemWifiPassword00;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemWifiPassword01;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemWifiPassword02;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemWifiPassword03;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemWifiPassword04;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemWifiPassword05;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemWifiPassword06;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemWifiPassword07;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemWifiPassword08;		/* Auto create code zone, don't modify or delete! */
	UINT8 SystemWifiPassword09;		/* Auto create code zone, don't modify or delete! */
	UINT8 ScdvPbFileType;		/* Auto create code zone, don't modify or delete! */
...
/* Note: You can add struct member after this line !!! */
	...
	////////////////////// FOR DVS5M2 ///////////////////////
	UINT8 ScdvMainMode;
	UINT8 SystemRfCuid[5];
	UINT8 SystemRfType;
	#ifdef USE_DVS5M2_HW
	UINT8 SystemRemoter;
	UINT8 SystemWifiPassword00;
	UINT8 SystemWifiPassword01;
	UINT8 SystemWifiPassword02;
	UINT8 SystemWifiPassword03;
	UINT8 SystemWifiPassword04;
	UINT8 SystemWifiPassword05;
	UINT8 SystemWifiPassword06;
	UINT8 SystemWifiPassword07;
	UINT8 SystemWifiPassword08;
	UINT8 SystemWifiPassword09;
	#endif
	////////////////////// FOR DVS5M2 ///////////////////////
	...
	UINT8 ParkingMode;
	UINT32 ReturnSetting;
	UINT8 HDMIplug0,HDMIplug1;
       UINT8 HDMIio0,HDMIio1;//ll@add
...
#endif /*__APP_UI_PARA_DVS5M2_H__*/
