#ifndef _APP_GPIO_HW_DVS5M2__H
#define _APP_GPIO_HW_DVS5M2__H
/* SPCA5330B */
...
#define GRP_LED_BUSY_FRONT             	SP5K_GPIO_GRP_GEN
#define OUT_LED_BUSY_FRONT              (const UINT32)(!VALO_GenGPIO(bit_1))
#define SET_LED_BUSY_FRONT(en)          sp5kGpioWrite(GRP_LED_BUSY_FRONT, 1<<CFG_LED_BUSY_FRONT, (!en)<<CFG_LED_BUSY_FRONT)
#define POL_LED_BUSY_FRONT             	SP5K_GPIO_ACTIVE_LOW
#define CFG_LED_BUSY_FRONT              PIN_1
...
#define IN_BATTERY_CHARGE_DETECT       	(VALI_LmiGPIO(bit_2))
#define POL_BATTERY_CHARGE_DETECT      	SP5K_GPIO_ACTIVE_HIGH
#define CFG_BATTERY_CHARGE_DETECT       PIN_2
